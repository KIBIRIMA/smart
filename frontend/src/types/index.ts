...
export interface Tournee { id: number; chauffeur_nom: string; vehicule_immat: string; nb_missions: number; km: number; co2_kg: number; taux_remplissage: number; depart: string; statut: string; couleur: string; itineraire: number[][]; explications: string[]; }
...
export interface OptimResultTour { index: number; couleur: string; missions: number[]; itineraire: number[][]; km: number; co2_kg: number; taux_remplissage: number; nb_missions: number; explications: string[]; }
